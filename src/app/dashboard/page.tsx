      ...
      <PageContainer
        title={
          <div className="flex flex-col gap-y-2">
            <div className="flex items-center gap-2 text-primary font-bold text-xs uppercase tracking-[0.2em] px-3 py-1.5 bg-primary/5 rounded-full w-fit border border-primary/10">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-[56px] font-black text-slate-950 leading-[1.1] tracking-tight">
        ...
        subtitle={
          <div className="flex flex-col gap-y-12 mt-4">
            <p className="text-slate-500 text-xl md:text-2xl font-medium leading-relaxed m-0 max-w-2xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl">
              {/* Card 1: Security */}
              <div className="p-5 rounded-2xl bg-white border border-slate-100 shadow-sm flex items-center gap-5 hover:border-primary/20 hover:shadow-md transition-all group">
                <div className="w-14 h-14 rounded-xl bg-emerald-50 text-emerald-600 flex items-center justify-center shadow-inner group-hover:scale-110 transition-transform">
                  <ShieldCheck size={28} />
                </div>
                <div className="flex flex-col gap-y-0.5">
                  <span className="text-[11px] font-black text-slate-400 uppercase tracking-widest">Status de Conformidade</span>
                  <span className="text-lg font-bold text-slate-900">Blindagem Ativa</span>
                </div>
              </div>

              {/* Card 2: AI Intelligence */}
              <div className="p-5 rounded-2xl bg-white border border-slate-100 shadow-sm flex items-center gap-5 hover:border-primary/20 hover:shadow-md transition-all group">
                <div className="w-14 h-14 rounded-xl bg-blue-50 text-blue-600 flex items-center justify-center shadow-inner group-hover:scale-110 transition-transform">
                  <Lightbulb size={28} />
                </div>
                <div className="flex flex-col gap-y-0.5">
                  <span className="text-[11px] font-black text-slate-400 uppercase tracking-widest">IA & Estratégia</span>
                  <span className="text-lg font-bold text-slate-900">4 Insights Gerados</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-8">
              <Link href="/estrategia">
                <Button size="lg" className="h-16 shadow-[0_20px_40px_-15px_rgba(37,99,235,0.4)] font-bold px-12 text-xl bg-primary hover:bg-blue-700 transition-all hover:scale-105 active:scale-95 group">
                  <Play className="w-6 h-6 mr-3 fill-white group-hover:animate-pulse" /> Iniciar Execução
                </Button>
              </Link>
        ...
        action={
          <div className="relative shrink-0 lg:mr-8 scale-[1.25] hidden lg:block transition-all hover:scale-[1.3] duration-500">
            <ExecutionShield />
          </div>
        }
      >
        <div className="flex flex-col gap-y-12">
          {/* Mobile Execution Shield */}
          <div className="lg:hidden flex justify-center mb-8">
            <ExecutionShield className="scale-75" />
          </div>
        </div>
